            ...
            <section>
                <div className='conte-msj'>
                    {mensajes.map((mensaje, id) => (
                        <div key={id} >
                            <p className={`user button ${mensaje.usuario === socket.id ? 'user1' : 'user2'}`}>
                                {mensaje.usuario.slice(0, 1)}
                            </p>
                            <p className={`msj ${mensaje.usuario === socket.id ? 'msj2' : 'msj1'}`}>
                                <p className='text'>{mensaje.mensajeChat}</p>
                            </p>
                        </div>
                    ))}
